...
(function (Aufgabe11) {
    ...
    function init() {
        ...
        for (let i = 0; i < Aufgabe11.baumdaten.length; i++) {
            ...
            baumart.id = Aufgabe11.baumdaten[i].element; //Baumart bzw. die id des Elements zuweisen, siehe Daten.ts
        ...
        for (let i = 0; i < Aufgabe11.kugeldaten.length; i++) {
            ...
            kugeln.id = Aufgabe11.kugeldaten[i].element; //Halterung bzw. id des Elements zuweisen, siehe Daten.ts
            kugeln.name = "kugel";
        ...
        for (let i = 0; i < Aufgabe11.kerzendaten.length; i++) {
            ...
            kerzen.id = Aufgabe11.kerzendaten[i].element;
            ...
            kerzenanzahl.name = "anzahl der kerzen";
        ...
        lieferoptionen.name = "lieferoptionen";
        for (let i = 0; i < Aufgabe11.lieferoptionendaten.length; i++) {
            let option = document.createElement("option");
            option.innerText = Aufgabe11.lieferoptionendaten[i].name;
            lieferoptionen.id = Aufgabe11.lieferoptionendaten[i].element;
    ...
    function CheckBoxKugelnPreisAuslesen(checkBoxElement, anzahl) {
        for (let i = 0; i < Aufgabe11.kugeldaten.length; i++) {
            if (Aufgabe11.kugeldaten[i].element == checkBoxElement.id) {
                Warenkorb(checkBoxElement.id, Aufgabe11.kugeldaten[i].name, Aufgabe11.kugeldaten[i].preis, parseInt(anzahl), checkBoxElement.checked);
            }
        }
    }
    function CheckBoxKerzenPreisAuslesen(checkBoxElement, anzahl) {
        for (let i = 0; i < Aufgabe11.kerzendaten.length; i++) {
            if (Aufgabe11.kerzendaten[i].element == checkBoxElement.id) {
                Warenkorb(checkBoxElement.id, Aufgabe11.kerzendaten[i].name, Aufgabe11.kerzendaten[i].preis, parseInt(anzahl), checkBoxElement.checked);
            }
        }
    }
    function AuswahlAuslesen() {
        ...
        if (lieferant != "") {
            ZuWarenkorb(Aufgabe11.lieferoptionendaten, true, lieferant);
        }
    }
